...
**Objective:**
If i have to explain in simple we have given a data set by analysis that data set we have to tell about what the growth of the credit card user. Like which age group use more credit card, in which city, what the occupation of the user. So we know who can buy the credit card.
